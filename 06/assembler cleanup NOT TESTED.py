...
def varparse(line, symboltable, basesymlength):
...
for line in mlist:
    #a instruction
    if line[0] == "@":
        line = varparse(line, symboltable, basesymlength) #Will convert variables to their register number equivalents, and leave non-variables (e.g @54) untouched.
