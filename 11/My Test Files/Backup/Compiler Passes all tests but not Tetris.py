...
def ifStatement(indent, itemcounter, fileLineList, ofile, classSymbolTable, subrSymbolTable, methodFlag, voidFlag, className):
...
def whileStatement(indent, itemcounter, fileLineList, ofile, classSymbolTable, subrSymbolTable, methodFlag, voidFlag, className):
